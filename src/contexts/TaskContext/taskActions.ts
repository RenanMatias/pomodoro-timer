// useReducer <- hook do React que recebe um reducer e um estado incial
...
// type <- o tipo da ação, geralmente uma string (pode ser anum, constante, etc)
// payload <- os dados extras enviados juntos com a action, se necessário para atualizar o estado
